...
3. **true**, the cross validation is part of the training part so if we used CV with the test set than the model training is relaying on the test set, so the test set is no longer valid for testing.
